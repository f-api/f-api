...
const extraEntries = distEntries.filter((entry) => entry !== "index.html");

if (extraEntries.length > 0) {
  throw new Error(
    `Build must output a single dist/index.html file. Extra dist entries found: ${extraEntries.join(", ")}`
  );
}
